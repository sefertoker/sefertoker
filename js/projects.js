document.addEventListener('DOMContentLoaded', () => {
  const projectData = {
    ...
    "EnvanterKayit": { category: "masaustu", languages: ["C#"] },
    "Envanter Kayit": { category: "masaustu", languages: ["C#"] },
    ...
    "Modern Web Page": { category: "web", languages: ["HTML", "CSS", "JavaScript"] }
  };
  ...
  const projectMeta = {
    ...
    "EnvanterKayit": { categories: ["uygulama", "web","masaustu"], newTitle: "Envanter Kayıt", description: "Hasatanede tekniker için envanter tutabilcek bir web uygulaması." },
